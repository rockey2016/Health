...
class LstmModel():
    ...
    def create_model(self):
        ...
        self._model.add(LSTM(self._units['ls_units1'], input_shape=(timesteps_in, dim_in), return_sequences=True))
        self._model.add(Dropout(self._dr))
        self._model.add(BatchNormalization())
        #self._model.add(LSTM(self._units['lstm_units']['units2'], return_sequences=True))
        #self._model.add(Dropout(self._dr))
        #self._model.add(BatchNormalization())
        self._model.add(LSTM(self._units['ls_units3'], return_sequences=True))
        self._model.add(Dropout(self._dr))
        self._model.add(BatchNormalization())
        self._model.add(LSTM(self._units['ls_units4'], return_sequences=False))
        self._model.add(Dropout(self._dr))
        self._model.add(BatchNormalization())
